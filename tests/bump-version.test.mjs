...
// フィクスチャだけで検証していると、実リポジトリに存在しないファイルを
// TARGETS に残したまま気づけない。実際のルートに対しても走らせる。
test("bump-version check mode runs against the real repository", () => {
  const result = run("node", [SCRIPT, "--root", ROOT, "--check"], {
    cwd: ROOT
  });
