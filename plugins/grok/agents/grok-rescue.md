...
- Always invoke the companion in the foreground. Never use a background task or detached process.
...
- Accepted model aliases are `fast`, `reasoning`, `multi`, `build`, and `latest`.
