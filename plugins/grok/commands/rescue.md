...
argument-hint: "[--background|--wait] [--resume|--fresh] [--model <model|fast|reasoning|multi|build|latest>] [--effort <low|medium|high>] [what Grok should investigate, solve, or continue]"
